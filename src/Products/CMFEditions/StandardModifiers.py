...
modifiers = (
    {
        ...
        "enabled": True,
        "condition": 'python: object and path("object/isPrincipiaFolderish|nothing") and not path("object/@@plone_context_state/is_structural_folder|nothing")',
    ...
    },
    {
        ...
        "enabled": True,
        "condition": "python:path('object/@@plone_context_state/is_structural_folder|nothing') or portal_type == 'Folder'",
        "wrapper": ConditionalTalesModifier,
        "modifier": OMOutsideChildrensModifier,
